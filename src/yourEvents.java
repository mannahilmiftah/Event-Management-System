...
public class yourEvents extends javax.swing.JFrame {

    public yourEvents() {
        initComponents();
    }
    
    public yourEvents(String Email, String fName, String userName){
        initComponents();
        try {
            ...
            String sql = "SELECT * FROM your_events WHERE email='"+Email+"'";
            st = con.prepareStatement(sql);
            rs = st.executeQuery();
            DefaultTableModel tb = (DefaultTableModel)event_table2.getModel();
            while(rs.next()){
        ...
        email.setText(Email);
        fullname1.setText(fName+" "+userName);
    }
    ...
    private void initComponents() {
        ...
        event_table2 = new javax.swing.JTable();
        ...
        cancel_reg.setBackground(new java.awt.Color(255, 255, 255));
        cancel_reg.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        cancel_reg.setForeground(new java.awt.Color(255, 34, 34));
        cancel_reg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/event/management/system/icons8-cancel-20.png"))); // NOI18N
        cancel_reg.setText("CANCEL");
        cancel_reg.setBorder(null);
        cancel_reg.setFocusable(false);
            ...
            .addGroup(side_panelLayout.createSequentialGroup()
                ...
                .addGroup(side_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(side_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(fullname1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)))
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, side_panelLayout.createSequentialGroup()
                ...
                .addGroup(side_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, side_panelLayout.createSequentialGroup()
                        ...
                        .addGap(59, 59, 59))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, side_panelLayout.createSequentialGroup()
                        .addComponent(cancel_reg, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(100, 100, 100))))
        );
        side_panelLayout.setVerticalGroup(
            ...
            .addGroup(side_panelLayout.createSequentialGroup()
                ...
                .addComponent(fullname1, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(email_label)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGap(30, 30, 30)
                .addComponent(cancel_reg, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        event_table2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        event_table2.setForeground(new java.awt.Color(34, 34, 34));
        event_table2.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane3.setViewportView(event_table2);
    ...
    private void search_barMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_search_barMouseClicked
        if(search_bar.getText().trim().isEmpty()){
            try {
                ...
                DefaultTableModel tb = (DefaultTableModel)event_table2.getModel();
                tb.setRowCount(0);
                String sql_00 = "SELECT * FROM your_events WHERE email=?";
    ...
    private void search_iconMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_search_iconMouseClicked
        if(search_bar.getText().trim().isEmpty()){
            ...
            try{
                ...
                PreparedStatement st;
                Connection con = db.con;
                String sql_22 = "SELECT * FROM your_events WHERE email=? AND event_name=? OR day=? OR date=?"
                + "OR time=? OR category=? OR venue=?";
                ...
                st.setString(7, search_bar.getText());
                ResultSet rs = st.executeQuery();
                DefaultTableModel tb = (DefaultTableModel)event_table2.getModel();
                tb.setRowCount(0);
                while(rs.next()){
    ...
    private void cancel_regActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancel_regActionPerformed
        if(fullname1.getText().trim().isEmpty() || email.getText().trim().isEmpty() || dept.getText().trim().isEmpty() ||
            ...
            try{
                ...
                if(rs.next()){
                    ...
                    st.setString(1, fullname1.getText());
                    st.setString(2, email.getText());
...
//                            st1.setString(7, evenue);
                            ...
                            JOptionPane.showMessageDialog(this, "Registration Cancellation Failed", "Message", 1);
                        }
                    }else{
                        JOptionPane.showMessageDialog(this, "Event Not Found", "Message", 1);
                    }
                }else{
                    JOptionPane.showMessageDialog(this, "You are not registered for this event", "Messages", 1);
                }
            }catch(SQLException s_ex){
                Logger.getLogger(DB_Connectivity.class.getName()).log(Level.SEVERE,null,s_ex);
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                yourEvents y_eve = new yourEvents();
                y_eve.setVisible(true);
                y_eve.pack();
                y_eve.setLocationRelativeTo(null);
            }
        });
    }
    ...
    private javax.swing.JTable event_table2;
