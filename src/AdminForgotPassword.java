...
public class AdminForgotPassword extends javax.swing.JFrame {
                ...
                .addGroup(forgotp_containerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(forgotp_containerLayout.createSequentialGroup()
                        ...
                        .addGroup(forgotp_containerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(admin_id, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(forgotp_containerLayout.createSequentialGroup()
                        .addGap(20, 20, 20)
    ...
    private void change_pActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_change_pActionPerformed
        ...
        if(admin_id.getText().trim().isEmpty() || change_password.getText().trim().isEmpty()){
                ...
                if(rs.next()){
                    ...
                    if(rs.next()){
                        ...
                        if(isValidPassword(password)){
                            ...
                            st.setString(2, admin_id.getText());
                            ...
                            JOptionPane.showMessageDialog(this, "Password must be of 8-15 characters", "Incorrect credentials", 1);
                        }                        
                    }else{
                        JOptionPane.showMessageDialog(this, "Incorrect ID", "Message", 1);
                        change_password.setText("");
                    }
