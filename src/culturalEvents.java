...
public class culturalEvents extends javax.swing.JFrame {

    public culturalEvents() {
        initComponents();
    }
    
    public culturalEvents(String Email, String fName, String userName) {
        initComponents();
        try {
            ...
            String sql = "SELECT * FROM events WHERE category='Culture'";
    ...
    private void initComponents() {
        ...
        cul_eve_label = new javax.swing.JLabel();
        ...
        cul_eve_label.setFont(new java.awt.Font("Tahoma", 1, 30)); // NOI18N
        cul_eve_label.setForeground(new java.awt.Color(34, 34, 34));
        cul_eve_label.setText("CULTURAL EVENTS");
    ...
    private void search_barMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_search_barMouseClicked
        if(search_bar.getText().trim().isEmpty()){
            try {
                ...
                DefaultTableModel tb = (DefaultTableModel)event_table.getModel();
                tb.setRowCount(0);
                String sql_00 = "SELECT * FROM events WHERE category='Culture'";
    ...
    private void search_iconMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_search_iconMouseClicked
        if(search_bar.getText().trim().isEmpty()){
            ...
            try{
                ...
                PreparedStatement st;
                Connection con = db.con;
                String sql_22 = "SELECT * FROM events WHERE category='Culture' AND event_name=? OR day=? OR date=?"
                + "OR time=? OR venue=?";
    ...
    private void registerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerActionPerformed
        if(fullname.getText().trim().isEmpty() || email.getText().trim().isEmpty() || dept.getText().trim().isEmpty() || 
            ...
            try{
                    ...
                    Connection con = db.con;
                    String sql_05 = "SELECT * FROM events WHERE event_name=? AND category='Culture'";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                culturalEvents cul_eve = new culturalEvents();
    ...
    private javax.swing.JLabel cul_eve_label;
