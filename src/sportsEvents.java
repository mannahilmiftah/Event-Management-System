...
public class sportsEvents extends javax.swing.JFrame {
    ...
    public sportsEvents(String Email, String fName, String userName) {
        initComponents();
        try {
            ...
            String sql = "SELECT * FROM events WHERE category='Sports'";
    ...
    private void initComponents() {
        ...
        sp_eve_label = new javax.swing.JLabel();
        ...
        sp_eve_label.setFont(new java.awt.Font("Tahoma", 1, 30)); // NOI18N
        sp_eve_label.setForeground(new java.awt.Color(34, 34, 34));
        sp_eve_label.setText("SPORTS EVENTS");
    ...
    private void search_barMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_search_barMouseClicked
        if(search_bar.getText().trim().isEmpty()){
            try {
                ...
                DefaultTableModel tb = (DefaultTableModel)event_table.getModel();
                tb.setRowCount(0);
                String sql_00 = "SELECT * FROM events WHERE category='Sports'";
    ...
    private void search_iconMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_search_iconMouseClicked
        if(search_bar.getText().trim().isEmpty()){
            ...
            try{
                ...
                PreparedStatement st;
                Connection con = db.con;
                String sql_22 = "SELECT * FROM events WHERE category='Sports' AND event_name=? OR day=? OR date=?"
                + "OR time=? OR venue=?";
    ...
    private void registerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerActionPerformed
        if(fullname.getText().trim().isEmpty() || email.getText().trim().isEmpty() || dept.getText().trim().isEmpty() || 
            ...
            try{
                    ...
                    Connection con = db.con;
                    String sql_05 = "SELECT * FROM events WHERE event_name=? AND category='Sports'";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                sportsEvents sp_eve = new sportsEvents();
                sp_eve.setVisible(true);
                sp_eve.pack();
                sp_eve.setLocationRelativeTo(null);
            }
        });
    }
    ...
    private javax.swing.JLabel sp_eve_label;
